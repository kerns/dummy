...
<h3>Tips</h3>
<ul>
  <li><p>The use of a virtual host for your web project is not only a solid best practice, it also makes configuring Dummy painless. For Mac users, I strongly recommend Patrick Gibson's excellent <a hred="https://github.com/pgib/virtualhost.sh">virtualhost.sh</a> script for creating and managing virtual hosts. But there are lots of command line and GUI based alternatives across all platforms.</p></li>
